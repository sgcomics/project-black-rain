label scene201:
    ...
    "하늘이가 금방이라도 울음을 터뜨릴 듯한 얼굴로 돌아간 뒤,\n나는 하늘이에게 무슨 일이 생겼으까, 어떻게 위로해줄까 고민하며 밤을 보냈다."

    "연우가 쓰러져서 걱정인 걸까? 혹시 그 원장에게서 크게 꾸지람을 들었던 걸까?"

    "새벽까지 생각에 생각을 거듭했지만, 그 어떤 것도 하늘이가 그런 얼굴을 할 만한 이유가 되지는 못했다."

    "결국, 쏟아져오는 잠기운에 나는 하늘이를 걱정하며 잠이 들었다."
    ...
    show hanbyeol shock
    show hanseol shock
    hanbyeol "쉿!" (multiple=2)
    hanseol "쉿!" (multiple=2)
    ...
    "문 틈으로 희미하게 불빛이 새어나온다. 하늘이가 먼저 도착한걸까?"

    "조심스레 문고리를 잡아당기자, 오래된 백열등 아래서 책을 읽고 있는 하늘이의 모습이 보인다."

    "책에 완전히 빠져있는지 문이 열리는 소리를 듣지 못한 것 같다."

    "따스한 오렌지색 불빛에 하늘이의 눈가가 반짝이고, 이윽고 자그마한 물방울이 되어 볼을 타고 흘러내린다."

    show yeongwon shock
    yeongwon "(울고 있잖아...? 역시 무슨 일이 있었던건가...?)"

    "문을 조금 더 열려고 한 발짝 내딛은 순간, 오래된 경첩에서 끼이익 소리가 울려퍼졌다."
    ...
    show yeongwon shock
    yeongwon "왜 울고 있어? 반에서 무슨 일 있었던거야?"
    ...
    show haneul serious
    haneul "그치만... 주인공의 친구는 과연 어떤 생각으로 주인공을 떠나보냈을까? {wait}\n그런 생각을 하니까 괜히 슬퍼져서..."
    ...
    "그렇게 잠시동안 소매로 눈가를 훔치던 하늘이는 밝게 웃으며 말했다."
    ...
    show haneul happy2
    haneul "정말 너희는 하나도 바뀐 게 없구나. 아직도 그렇게 티격태격 하는거야?"

    show yeongwon idle
    yeongwon "한설이만 아니면 이렇게 말다툼할 일도 없었어..."

    show hanseol happy
    # Comment: 말투 출처: 예랑가랑 유튜브
    ...
    "살며시 옆을 돌아보자 새어나오려는 웃음을 열심히 참는 하늘이가 보였다."
    ...
    show yeongwon happy
    yeongwon "자자, 이제 이상한 콩트는 그만 하고 뭐 먹으면서 얘기라도 하자.\n오늘은 탕비실에서 쿠키 조금 가져왔어."

    show hanbyeol sad
    hanbyeol "직권 남용이야, 그거."

    show yeongwon happy
    yeongwon "뭐 어때, 어차피 다른 사람들도 조금씩 가져가고 있는걸."

    show hanbyeol shock
    hanbyeol "...! 그건 몰랐네..."

    "비닐 포장지에 담긴 싸구려 버터향 쿠키를 집으며 haneu야기를 나눴다."

    "* * *"

    show hanseol sad
    hanseol "...그래서 쟤는 반장이라는 애가 맨날맨날 haneu있는 게 귀신인지 사람인지 분간이 안 간다니까!"

    show hanbyeol idle
    hanbyeol "자라고 몇 번을 말해도 안 들어. 하늘이 네가 좀 얘기해줘봐."

    show haneul idle
    haneul "아무리 할 일이 많아도 그렇지, 잠 자는 건 중요해, 영원아. 아프면 여기로 놀러올 수도 없잖아?"
    ...
    show yeongwon serious
    yeongwon "(한숨)알았어, 알았어. 내가 다 미안해, 다음부터는 안 그럴게."
    ...
    show haneul happy
    haneul "쿡쿡. 난 그저 너희들이 보고싶었을 뿐인걸. 옛날 생각이 나서 난 이쪽이 더 좋아."

    show yeongwon idle
    yeongwon "생각해보니 옛날부터 이렇게 맨날 싸웠는데. 하늘이 네가 없으니까 브레이크를 걸어줄 사람이 없더라."
    ...
    show yeongwon idle
    yeongwon "연우도 같이 왔으면 좋았을 텐데. 몸 상태는 조금 어때?"

    show haneul serious
    # Comment: 여기서 하늘이가 깜짝 놀라는 연출이 있었으면 좋을지도
    haneul "아... 그......."
    ...
    show haneul happy
    # Comment: 억지웃음을 짓는 장면으로 생각하고 있는데 성격에 맞는 행동인지 살짝 헷갈림
    haneul "이미 익숙해졌어!"
    ...
    show yeongwon happy
    yeongwon "아, 아니 그냥. 슬픈 표정 하니까... 저... 그 귀여운 얼굴이 다 망가지잖아." # 으악 내 손이 사라진다

    show haneul serious
    haneul "......"

    # Comment: 이부분 빼면 안됩니까 작가양반
    ...
    "차라리 하늘이가 영재반을 그만두고 일반반으로 내려와줬으면, 하고 마음 속으로 떼를 써 본다."

    "하늘이가 똑똑하고, 나중에 사회에 도움이 되는 일을 맡게 될 거라는 건 알지만, 그래도 하늘이가 힘들어하는 모습은 보기 싫다."

    "아무것도 아닌 나는 그저 하늘이가 우는 모습을 바라보고, 등을 토닥여주는 것 밖에는 할 수 없었다."

    # Comment: 이건 좀 초 치는 텍스트라 일단 보류
    ...
    "한설이와 한별이에게 하늘이의 우는 모습을 들킨 뒤로 잔뜩 놀림 받고 그 뒤로도 한동안 구박을 받아서 그 동안은 얌전히 지냈다."

    "잠도 억지로 자고 하늘이의 상황에 대해서도 최대한 긍정적으로 생각하려고 노력했더니 선생님께는 안 들킨 것 같다."

    "하지만 한설이에게는 구박을 많이 받았다. 쳇, 나를 너무 잘 알아."

    show hanseol idle
    hanseol "영원아, 어제 비밀 우편함 확인해 봤어?"
    ...
    # FX: NVL Mode
    # Comment: Fullscreen, Handwriting Fonts
    ...
    show hanseol shock
    # Comment: "뭐야, 오늘은 안전한 날이라면서?!" 되게 이상하게 들린다
    ...
    show yeongwon shock
    yeongwon "몇 명은 건물 뒤쪽으로 돌아간 걸 보니까 경계선 점검 나간 것 같아. 그 쪽도 위험해."

    show hanseol shock
    hanseol "아아아... 뭐야, 우리 구교사에 갇힌 거야?!"

    show yeongwon shock
    yeongwon "구조상 경비들이 나가기 전까지는 못 나갈거야. 으으, 설마 오늘 기숙사 사감이 점호 하는건 아니겠지?"
    ...
    show yeongwon idle
    yeongwon "조금만 참아. 여기서 기다리다가 경비 아저씨 나갈 때 따라 나가면 되는거야."

    show yeongwon idle
    yeongwon "그나저나 가방 들고 오길 잘했다. 아니었으면 지금쯤 아지트 들켜서 비상상황이 됐을걸."

    show hanbyeol shock
    hanbyeol "새것같아 보이는 책이나 카드같은거 전부 챙겨 온 거 맞지?"

    show yeongwon idle
    yeongwon "가구도 어지럽혀 놨어. 걱정하지 마."

    show hanseol happy
    hanseol "맞아! 나도 내 웨이스트 백에 있는 거 빼고 보드게임같은 거 넣어왔다구."

    show hanbyeol shock
    hanbyeol "{slow}......{/slow}뭐라고?"
    ...
    "무전기" "치직- 칙- 259호에서 최근에 사람이 있었던 흔적을 발견했습니다. 주의하세요- 치직-"
    ...
    show hanbyeol shock
    hanbyeol "---아, 저기 옆에 출입금지라고 써 있는 간이문, 저기라도 들어가있자!"
    ...
    show hanbyeol shock
    hanbyeol "바깥에 열쇠구멍같아 보이는 게 없었잖아? 근데 안에서는 잠글 수 있게 돼 있네. 특이하다."

    show yeongwon serious
    yeongwon "그러네? 의외로 여기는 제어실이 아니라 그냥 예전에 쓰이던 직원 휴게실일지도."

    show hanseol sad
    hanseol "우우... 얘들아, 우리 불이라도 켜면 안될까...?"
    ...
    "책상 저편에 놓여진 컴퓨터는 자그마한 전구를 반짝이며 주인이 돌아오기를 기다리는 듯했다."

    show hanseol sad
    hanseol "여기... 진짜로 우리 고아원 맞아?"

    show  shock
    hanseol "우리 어쩌면 와서는 안되는 곳에 온 거 아닐까...?!"
    ...
    "...............는 인간 신체에 변칙적인 변화를 일으키는 종류의 것으로 보인다.\n............의 효과가 완벽하게 검증되기 전까지는 발설을 금하며, 정보조작을\n.........히, 교육 기관의 역할이 가장 큰데, 정부의 관리 하에 교육과정을 개편\n...........의 존재를 시민의 기억 속에서 완전히 지워야 한다. 일반 시민에 대한\n..........억 소거제의 사용은 현재 상부의 결정을 기다리고 있다."

    show hanseol idle
    hanseol "앞부분이 하나도 안 보이는데? 이거 뭐야?"

    show hanbyeol idle
    hanbyeol "모르겠어. 냄새도 많이 나지는 않는데... 곰팡이 이런 거 아닌가?"

    show hanseol shock
    hanseol "으악?! 내가 곰팡이를 만지고 있었던 거야?!"

    show yeongwon serious
    yeongwon "아니, 그게 문제가 아니야. 이거 도대체 무슨 소리야?"

    show hanbyeol idle
    hanbyeol "몰라. 그래도 이 실험실...? 같은 곳에 뭔가 단서가 있겠지."
...
label scene202:
    ...
    "산소를 원하는 몸은 죽을 힘을 다해 숨을 들이쉬지만 기도로 흘러들어가는 건 공기가 아닌 입에 가득한 피고름과 거품이었다."

    fstudent "컥... 커억....!"

    "강렬한 이물감에 들이쉰 것을 토해내지만 나오는 것은 불길할 정도로 새까만 핏덩이 뿐이었다."

    "아이의 새하얗던 환자복은 점점 검붉은 색으로 물들어갔다."

    "그러나 원장은 수술대 옆에서 여자아이를 그저 관찰할 뿐이었다."
    ...
    "그렇지만 그 때 읽은 자료에서는 원인불명이라고 했다."

    "나는 지금까지 바깥에 나가면 몸이 불타는 듯 아프고, 병에 걸려 죽는다고 배웠다."

    "그렇지만 그 때 읽은 노트에서는 그저 몸이 변하는 과정이라고 했다."

    "나는 지금까지 반사 패널 안에서만 사람이 살 수 있고, 바깥에 나가서 생긴 병은 치료할 수 없다고 배웠다."

    "그렇지만 그 때 읽은 노트에서는 어려운 이름을 가진 치료약이 효과가 있을 것 같다고 했다."
    ...
    show yeongwon sad
    yeongwon "그건 맞지... 나도 비슷한 생각 하느라 잠 제대로 못 잤어."
    ...
    show yeongwon idle
    yeongwon "으아, 들키겠다. 이따가 점심때 다시 얘기하자."
    ...
    "계속된 수업에 질린 아이들은 모두 삼삼오오 모여 배급받은 도시락을 열고 있었다."

    "한별이와 한설이가 도시락을 받아 오기를 기다리며 미리 슬쩍 메뉴를 확인한다."

    "인공육 함박 스테이크."

    show  happy
    "평소 음식보다 괜찮은 식사에 안도의 한숨을 내쉰다."
    ...
    "열린 교실 문으로 한별이와 한설이가 들어온다."

    "이 고기의 출처에 관해서 토론하고 있는 듯 하다."
    ...
    "셋이서 머리를 맞대고 소곤소곤 이야기를 시작한다."

    show yeongwon serious
    yeongwon "어제 그 방에서 읽은 문서 있잖아? 뭔가 수상해."

    show hanbyeol serious
    hanbyeol "나도 그렇게 느꼈어. 어제 밤에 계속 생각해 봤는데 뭔가 위화감이 있어."

    show yeongwon serious
    yeongwon "응. 우리가 지금 배우고 있는 내용이랑 전혀 다른 이야기도 적혀 있었고..."

    show yeongwon serious
    yeongwon "그러면 어느 쪽이 맞는 걸까? 지금 우리가 보고 있는 교과서? 아니면 어제 본 그 오래된 연구 노트?"
    ...
    yeongwon "더 최근의 연구 결과를 찾아봐야지. 반장 권한으로 이것저것 찾아보기는 하겠지만 아마 한계는 있을거야."
    ...
    "그 때 적혀있던 치료약에 대한 정보를 조금이라도 더 얻어야 한다."

    "어째서 선생님들은 치료약이 있을 수도 있는데도 우리에게 알려주지 않는지 알야아만 한다."
    ...
    yeongwon "그러면 연구 결과같은 걸 찾을 수 있을 만한 곳은 어디어디 있을까?"

    show hanbyeol idle
    hanbyeol "일단 도서관이 먼저겠지. 만약 실제로 정보조작이 진행되고 있다면 별 수확은 없겠지만 너는 반장이니까 이것저것 핑계를 대면 쉽게 들어갈 수 있을 거야."

    yeongwon "교무실도 한 번 가봐야지. 여러 선생님들이 계시니까 뭔가 비밀 폴더 같은 것도 있을 법 한데."
    ...
    hanbyeol "그 정도면 완벽하기까지는 아니어도 선생님들이 우리에게 뭔가를 숨기고 있다는 결정적 증거는 찾을 수 있을거야."
...
label scene213:
    ...
    yeongwon "그러면 나는 도서관을 가볼게. 아까도 말했듯이, 학습자료를 복사하러 왔다고 말하면 제한구역까지는 사서 선생님이 데려다 줄 거야."

    show hanseol happy
    hanseol "그러면 나는 원장실에 갈래~! 항상 거기를 지나다니니까 경비원이 언제 나오는지 정도는 알고 있어~!"

    hanbyeol "...그러면 나는 교무실이겠네. 선생님들이 안 계실 때 한 번 둘러보고 올게."

    yeongwon "좋아, 그럼 각자의 역할도 결정된거네?"
    ...
    "다음 날 수업 준비라는 핑계로 평소 갈 수 없는 도서관 깊숙한 서고에 들어가 봤다."
...
label scene223:
    ...
    "공부를 열심히 한다고 옆 반 담임 선생님께서 사탕을 주셨지만, 별로 기쁘지 않았다."
...
label scene233:
    ...
    hanseol "나는 그럼... 교무실로 할게. 도서관처럼 책 냄새 나는 곳은 싫어어..."
    ...
    "가방을 주섬주섬 챙겨들고 선생님께 가서 결재서류 전달을 대신 해 드리겠다고 이야기했다."

    "선생님은 이전에 본 시험지 채점으로 많이 바쁘셨는지, 그래 주면 고맙겠다고 말씀하셨다."
    ...
    "일단 결재 서류는 전달해 드려야 하고, 혹시 저 약병이 치료약일지도 모르니 조심스레 원장선생님을 따라갔다."

    "* * *"

    "잠시 후, 원장 선생님이 도착한 곳은 그 때의 오래된 실험실과 비슷한 느낌의, 아니, 거의 똑같은 실험실이었다."

    "자동문 사이로 안을 엿보던 나는 수술대에 누워 있는 두 개의 인영을 보았다."
    ...
    "끊임없이 지속되는 전자음에 화들짝 놀라 다시 실험실 안을 들여다본다."

    "깨끗했던 실험실 바닥은 이미 피바다로 변해 있었고, 여자아이의 팔은 실험대 바깥으로 추욱 늘어져 움직이지 않았다."

    "원장선생님은 다시 약병을 꺼내들더니 하늘이 곁으로 간다."

    "안돼, 하늘이만은 안돼! 저런 꼴으로 죽게 할 수는 없어!"

    "???" "학생, 더 이상은 안 돼."

    "갑자기 뒤에서 어떤 남성의 목소리가 들려온다."
    ...
    "???" "괜찮아, 아프지는 않게 해 줄게. 나도 사람이야?"

    "???" "그러려고 가져온 고성능 마취제거든."

    "나... 마취제에...?"

    "가슴팍에 무엇인가가 꽂히는 듯한 느낌이 났다."
