define yeongwon = Character('영원', color="#c8ffc8")
define haneul = Character('하늘', color="#c8ffc8")
define hanuellong = Character('하늘(장)', color="#c8ffc8")
define hanbyeol = Character('한별', color="#c8ffc8")
define hanseol = Character('한설', color="#c8ffc8")
define yeonwoo = Character('연우', color="#c8ffc8")
define principal = Character('원장', color="#c8ffc8")
define overwatch = Character('감시자', color="#c8ffc8")
define keibi = Character('경비원', color="#c8ffc8")
define teacher = Character('선생님', color="#c8ffc8")
...
#dark char img
#ex: image yeongwon serious dark = im.MatrixColor("yeongwon/serious.png", im.matrix.brightness(-0.2))
...
#bg images
image background classroom = "background/classroom.jpg"
image background hallway = "background/hallway.jpg"
image background hideout = "background/hideout.jpg"
image background lab = "background/lab.jpg"
image background oldschool = "background/oldschool.jpg"
image background school = "background/school.jpg"
image background sky = "background/sky.jpg"
image background stairs = "background/stairs.jpg"
image background what = "background/what.jpg"
image background what2 = "background/what2.jpg"
...
label start:
    ...
    "나보고 제안을 빌미삼아 그쪽에 붙으라는 말이나 다름없었다."

    "하지만 순순히 따르는 것이 최선의 방법일지도 모른다."

    "그러면 쉽게 원장의 계획을 파낼 수도 있을 거고, 하늘이만 구하는 게 아니라..."
    ...
    show yeongwon idle:
        moveleft
    yeongwon "선생님... 정말로 그렇게 해 주실 수 있다면, 저는..."

    show yeongwon idle dark
    show hanbyeol shock at right
    with Dissolve(.5)
    hanbyeol "야!!!! 정신 차려!!!!! 지금 뭐 하려는 거야!!!!!"

    hanbyeol "넘어가지 마!!! 저 여자 손에 연우와 한설이가 죽은 거나 마찬가지잖아!!!"

    show hanbyeol sad at right
    hanbyeol "이러다 너 마저 그렇게 되어 버린다면... 영원아, 제발..."
    show hanbyeol sad:
        moveslightleft
    with Pause(0.5)
    show hanbyeol sad dark
    show keibi idle dark at slightright
    with Dissolve(.5)
    ...
    "원장의 말이 끝나기가 무섭게 경비가 한별이와 하늘이를 데리고 밖으로 나갔다."

    "다만 한별이와는 다르게, 하늘이는 끌려 나가는 것이 아닌 자의로 나가는 것 처럼 보였다."

    show hanbyeol fury
    with Dissolve(.5)
    hanbyeol "원장!!! 무슨 짓을 하려는 거야!!! 하지 마. 영원이 꼬드기지 마!!! 너 때문에 나와 내 친구들이..."

    hide hanbyeol fury
    with Dissolve(.5)
    "한별이는 끌려 나가는 순간까지 원장에게 욕설을 퍼부었다."

    "나는 한별이의 욕을 차마 견딜 수가 없었다."

    "분명 원장에게 하는 말이겠지만 어쩐지... 그 말이 꼭 나에게 하는 것만 같았기 때문이다."

    "결국 한별이에게서 고개를 돌려 하늘이를 바라보았다."

    "가장 소중한 사람, 나를 이해해 줄 수 있을 유일한 사람."

    "그 모든 기대감을 품은 채 나는 간절한 얼굴로 하늘이를 쳐다보았다."

    "하지만... 그의 반응은 싸늘했다. 단지 나를 슬픈 눈으로 쳐다 볼 뿐이었다."
    ...
    with Dissolve(.25)
    principal "이제 우리 둘만 남았으니까... 하던 이야기를 계속 해 볼까?"

    principal "영원아, 아까 전 처럼 애매하게 대답하지 말고, 이번에는 확실하게 해 주렴."

    principal "정말로 내 제안을 받아들일 생각이니?"

    "이제 더 이상은 주저할 수 없다. 내 선택이 옳았다는 것을 모두에게 증명해 보일 거야."
...
label part2:
    ...
    "나와 함께 해 온 소중한 친구들이 저렇게 반응한다면, 다른 아이들은 안 봐도 뻔할 노릇이다."
    "왜 모두들 나에게 원망의 눈초리만을 보내는 걸까...??"
    "나름대로 깊게 고민해서 내린 결정이었는데 말이다."
    "...아니야. 모두들 친한 친구들이잖아. 나중에라도 설명한다면 분명히 이해해 줄 거야."
    "그렇게 생각하고, 일단은 내 선택에 따라 나아가자."
    "긍정적으로 생각하려고 노력했지만, 사실 아직까지도 확신이 서지 않는다."
    "친구들이 내 행동을 이해해 줄지, 이것이 옳은 선택인지까지 말이다."
    ...
    "고민하고 있느라 원장이 무엇을 하는 지 살펴보지 못했다."
    ...
    "그럼 조금만... 먹어볼까..."
    "(우물우물)"
    "정신을 차려 보니 어느샌가 음식을 전부 먹어치훈 후였다."
    ...
    principal "그렇지?? 사실 내가 도도한 이미지랑은 다르게 이런 취미가 있어서 말이야. 맛있게 먹어 줬다니 고맙네~"
    ...
    principal "걱정하지 마. 내가 처음에 제안하지 않았니?? 친구들 목숨은 너에게 달려 있다고."
    ...
    "원장은 생각했던 것과는 다르게 매우 친절했다. 가식일지도 모르지만 말이다."
    "하지만 가식이건 아니건, 원장에게는 그 자체만으로 사람의 마음을 흔드는 매력이 있다."
    "친구들은 지금쯤 뭘 하고 있을까?? 정말 원장의 말대로 아무 일도 없는 걸까??"
    "그것보다, 내가 지금 이곳에서 이런 환대를 받는 것이 과연 맞는 일일까??"
    "아니야. 마음을 다잡아야 해. 친구들을 지키는 길이잖아..."
    "이런저런 생각을 해서인지, 목욕물이 너무 뜨거웠는지, 머릿속이 점점 달아오른다."
    "결국 목욕은 얼마 하지 못한 채 밖으로 나올 수 밖에 없었다."
    ...
    principal "목욕은 좀더 오래, 몸이 완전히 풀릴 때 까지 하는 거야."
    ...
    principal "잠은 내 침대에서 자렴. 아, 나는 소파에서 자면 되니까 부담없이 잘 수 있을 거야."
    ...
    "딱히 당신이 어디서 자는지 안 궁금했는데..."
    "잠옷으로 갈아입은 뒤, 원장의 안내를 따라 나는 침대로 향했다."
    "기숙사의 것과는 전혀 다른 푹신한 침대는 마치 구름같아서 눕자마자 푹 잠이 들 것만 같았다."
    ...
    "이렇게 사는게, 정말 모두를 위한 길일까?"
    "점점 더 두려워지기 시작했다."
    "고아원과는 다른 안락한 삶 속에서, 내가 이것을 누릴 자격이 있는지에 대한 회의감부터"
    "나를 원망의 눈초리로 바라볼 친구들의 시선. 그리고,"
    "모두를 위한 일이라 믿었던 내 개인적인 신념의 흔들림까지 모든 것이 두려웠다."
    "내 마음의 혼란을 아는지 모르는지, 원장이 나를 대하는 태도는 점점 더 부드러워졌다."
    "이런 나를 따뜻하게 대해주는 원장 선생님은 한 번도 본 적 없는 엄마 같았다."
    ...
    show yeongwon serious
    with Dissolve(.5)
    yeongwon "원장 선생님... 연우가 죽고, 한설이도 제 손으로 죽인 것이나 마찬가지인 시점에서..."
    yeongwon "저는 다른 친구들이라도 지켜 주고 싶었어요."
    yeongwon "아니, 아예 연우와 한설이 같은 피해자가 다시는 나오지 않게 하리라고 다짐했었죠."
    yeongwon "그래서 선생님의 제안을 받아들였어요."
    show yeongwon sad
    with Dissolve(.25)
    yeongwon "하지만... 저에게는 차가운 시선만이 돌아왔죠."
    yeongwon "그것 뿐만이 아니에요. 친구들을 버리고 저만 이곳에서 호화롭게 생활하고 있어요."
    yeongwon "모두를 위하겠답시고 엄청 고민했는데... 친구들을 버리고 혼자만 이렇게 사는 건 말이 안 돼요."
    yeongwon "선생님. 저는 처음부터 선택을 잘못 한 걸까요...??"

    hide yeongwon sad
    with Dissolve(.5)

    "원장은 내 말을 듣고 잠시 생각에 잠기는 듯 했다."

    show yeongwon sad dark at left
    with Dissolve(.5)
    show principal cry at right
    with Dissolve(.5)

    principal "영원아. 네가 왜 내 제안을 받아들였을 것 같아?? 스스로 한 번 생각해 봤니??"
    ...
    principal "아마 내 제안을 들었을 때도... 그런 마음이 있었기 때문에 받아들이겠다는 생각을 했을 거야."
    ...
    show yeongwon idle2 at left
    with Dissolve(.25)
    show principal happy2 dark at right
    with Dissolve(.25)
    yeongwon "그건 아니에요. 그냥 이야기가 조금 다른 길로 빠진 것 같아서..."

    show principal idle2 at right
    with Dissolve(.25)
    show yeongwon idle2 dark at left
    with Dissolve(.25)
    principal "미안해. 안 그래도 이제 막 중요한 이야기를 하려던 참이야."

    hide principal idle2
    with Dissolve(.25)
    hide yeongwon idle2 dark
    with Dissolve(.25)
    ...
    principal "누군가는 잘못된 선택으로 후회하기도 하지만, 다른 누구는 올바른 선택으로 주변에 도움을 주지."
    ...
    principal "친구들을 위한 선택을 한다는 건 네가 누구보다 착한 마음을 가지고 있다는 증거야."
    ...
    with Dissolve(.25)
    principal "그런거야. 어쨌든, 영원이가 나에게 고민을 털어 놓다니, 선생님은 정말 기분 좋은걸~??"
    ...
    yeongwon "선생님... 부탁이 하나 있어요. 음... 친구들이 어떻게 되었는지 걱정돼요. 그러니까... 잠깐 나갔다 와도... 괜찮을까요??"
...
label part3:
    ...
    hanbyeol "야!!! 영원!!! 이 나쁜 녀석아!!!"
    hanbyeol "진짜 우리 버리고 그 여자 말을 듣는 게 말이나 돼?? 나쁜 녀석아..."
    show hanbyeol sad
    with Dissolve(.25)
    hanbyeol "왜 혼자 위험한 데 뛰어드는 거야 왜!!!"
    hanbyeol "정말... ... ...너까지 잃을까 봐 얼마나 걱정했는데... 그것도 모르고..."
    ...
    hanbyeol "갑자기 경비 아저씨가 나한테 빨리 하늘이 데려 가라는 거 있지..."

    show hanbyeol idle2 dark at right
    with Dissolve(.25)
    "한별이는 소매로 슬쩍 눈물을 닦았다."
    ...
    "당장이라도 달려가 껴안고 싶었지만, 어쩐지 우리 둘 사이에 감도는 쎄한 기운 때문에 조금 망설여졌다."
    ...
    show hanbyeol shock at slightleft
    with Dissolve(0.5)
    show yeongwon idle dark at left
    with Dissolve(0.5)
    ...
    show haneul serious
    with Dissolve(0.25)
    show hanbyeol shock dark at slightleft
    with Dissolve(0.25)
    haneul "아니. 지금 당장 물어봐야 할 것 같아."
    haneul "사실 요즘 이상한 낌새가 이만저만이 아니야..."
    show hanbyeol idle2 dark at slightleft
    with Dissolve(0.25)
    haneul "특별반 학생들을 대상으로 무언가 자행되고 있다는 건 알지?"
    haneul "처음엔 고생했다고 주는 음료수인 줄 알았는데, 날이 갈수록 애들이 이상해지면서 낌새가 느껴졌지."
    haneul "아마 그때일 거야. 너희가 나 안 보인다고 했을 무렵이."
    haneul "연우도 그렇게 죽었고... 나도 거의 죽을 뻔 했어."
    ...
    haneul "난 특별반 아이들이 현이씨처럼... 생체실험을 받은 것 같다고 생각해."
    haneul "나는 그 중 유일한 성공 케이스고."
    ...
    haneul "그 때가 되기 전에... 고아원 아이들을 모두 탈출시켜야 해. 영원아, 빨리..."
    ...
    "모두 구해주기 위해서는 원장의 도움을 받아야 하는데... 친구들을 어떻게든 설득하는 수 밖에."

    show haneul serious dark
    with Dissolve(0.25)
    show yeongwon serious2 at left
    with Dissolve(0.25)
    yeongwon "하늘아, 나... 널 믿는 거 알지...??"
    show yeongwon sad2 at left
    with Dissolve(0.25)
    yeongwon "그런데 이번에 네가 하는 말에는 동의해 줄 수가 없어."
    show yeongwon serious2 at left
    with Dissolve(0.25)
    yeongwon "원장은 정말 좋은 사람이었어. 너희가 생각하는 것 보다 훨씬."
    yeongwon "그런 사람이 수상하다니... 그건 좀 아닌 것 같아."
    show hanbyeol shock2 dark at slightleft
    show hanbyeol shock2 dark at slightleft:
        moveslightright
    show haneul shock dark at right
    show yeongwon shock2 at left
    with Pause(0.5)
    yeongwon "무, 물론 완전히 신뢰하는 건 아니야!! 우리가 모르는 데서 뭔가 어두컴컴한 일을 할 지도 모르지만!!"
    show yeongwon serious2 at left
    with Dissolve(0.25)
    ...
    yeongwon "너희가 원장을 믿지 않을 지는 모르지만, 적어도 나는 믿어 줄 수 있을 거 아니야..."
    ...
    show haneul shock dark
    with Dissolve(0.25)
    yeongwon "연우랑 한설이 그렇게 가고, 하늘이 너도 온갖 고통을 겪고..."
    ...
    yeongwon "너희도, 목표도 버린 내가 과연 이 행복한 생활을 누릴 자격이 있을까 하는 생각 뿐이었어."
    yeongwon "그때 고민하는 내 곁에서 원장 선생님이 함께 해 줬지."
    yeongwon "진지하게 내 문제를 들어 주고, 해결책을 내 주고..."
    show yeongwon serious at left
    with Dissolve(0.25)
    yeongwon "그때 난 생각했어. 원장 선생님은 나쁜 사람이 아니다. 언제라도 나를 도와줄 사람이다."
    ...
    hanbyeol "원장실에 너무 오래 있다 보니 이제 원장의 좋은 점 밖에 생각나지 않는 거야??"
    ...
    yeongwon "처음 원장 선생님의 제안을 받아들인 것도 그렇고, 모두 너희가 살아 주기를 바라는 마음에서 나왔어."
    ...
    "정말로 모두가 큰 일에 휘말렸다면, 누군가는 눈에 불을 켜고 우리를 찾으려 하겠지."
    "그걸 막기 위해서라도 강한 힘을 가진 어른의 보호를 받을 필요가 있어."
    "...하지만 둘 다 내 말을 들을 생각이 없어 보인다."
    "서로를 설득하기 위한 말이 오고 갈수록 점점 더, 나는 그들에게 이상한 아이로 보여지는 듯 했다."
    ...
    "하늘이가 어떤 일을 당할 지 생각해 보면, 무슨 수를 써서라도 잡아 놓고 싶었다."
    "하지만 아무리 부르고, 목놓아 울어 봐도 하늘이는 돌아 오지 않는다."
    "... 그는 더 이상 나를 믿지 않는다."
    ...
    "결심했다. 이제부터는 무슨 수를 쓰더라도 내 판단을 모두가 따르도록 만들 것이다."
    "그래야만 모두를 구할 수 있다."
    "난 옳은 판단을 내리고 있으니까."
...
label part4:
    ...
    show teacher idle dark
    with Dissolve(0.25)
    keibi "말 그대로야. 악.랄. 자기 말에 조금이라도 따르지 않으면 무조건 찍어누르려 하는 폭군이지."
    ...
    keibi "그런데 그 사건이 일어나기 며칠 전. 웬 여자애 하나가 전 원장 손을 잡은 채 갑자기 정부군 앞에 나타났다지."
    keibi "그 여자애 출신에 대해선 말이 많아. 사태에 휘말린 민간인이라고도 하고, 고아들 중 하나라고도 하고..."
    keibi "그 뒤 염소 고아원이 다시 운영을 시작하자 젊은 원장이 새로 부임했는데, 사람들 말로는 그때 그 여자애라더군."
    keibi "염소 고아원 원장... 정부에서 교육받을 때도 말이 많았어. 아주 미친년이라고..."
    keibi "뭐, 난 충분히 경고했수. 들어가도 본인 손해요!!"
    ...
    yeongwon "그 때는 선지자들이 개발한 기술로 만들어진 안전 구역 안에서 사람들이 살았죠."
    yeongwon "그러던 어느 날, 안전 구역 밖에서도 살아갈 수 있는 사람이 나타났어요."
    yeongwon "바로 이곳, 염소 고아원에서요."
    yeongwon "(수업종이 울렸다.)"
    yeongwon "그러면 오늘은 여기까지. 모두 수고하셨어요."
    show yeongwon happy dark
    with Dissolve(0.25)
    "하늘이에 대한 수업을 할 때 마다, 가슴 한 켠이 아파 온다."
    "그가 내 제안을 거부한 그 날, 하늘이는 자신의 계획에 따라 탈출을 감행했지만,"
    "결국 한별이를 포함한 모든 친구들을 잃고 자신도 정부군에게 잡혀 가고 말았다."
    "그 뒤로 나는 다시는 하늘이를 보지 못했다."
    "허망하게 친구들을 모두 잃은 뒤, 나는 거의 제정신이 아니었다."
    "소중한 하늘이를 잃은 sad, 아무도 지키지 못하고 혼자만 살아남은 나 자신에 대한 원망이 나를 짓눌렀다."
    "하지만 그럼에도 버틸 수 있었던 건, "
    "절대 흔들리지 않을 확고한 생각이 내가 어디로 가야 할 지를 알려 주고 있었기 때문이다."
    "그 후로 나는 원장 선생님을 따라 정부 기관에서 교육을 받았다."
